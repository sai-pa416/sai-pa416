...
<!-- 📦 PROJECTS SHOWCASE
     Once you have repos, uncomment and repeat the block below.
     Replace REPO_NAME with each repository name.
     The pinned card is generated by the workflow (add a matching
     "Generate pin card" step to .github/workflows/update-cards.yml),
     or just link the repo directly.
-->
...
<p align="center">
  <a href="https://github.com/sai-pa416/REPO_NAME">
    <img src="profile/pin-REPO_NAME.svg" alt="Project card"/>
  </a>
</p>
-->
